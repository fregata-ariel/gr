"""
Pure synthetic CFG generation — no visualization dependencies.

Extracted from main.py so that dataset pipelines can import the
generator without pulling in matplotlib.  Fully deterministic for a
given (num_nodes, edge_prob, seed); this is what makes provenance-based
sample_id derivation and split separation work.
"""
...
GENERATOR_NAME = "generate_cfg"


def generate_cfg(engine: GraphEngine,
                 num_nodes: int = 12,
                 edge_prob: float = 0.5,
